...
{   
    ...
    xTaskCreate( vADCDataProcessingTask,  "vADCDataProcessingTask",  310, 0, 1,&HandleADCDataProcessing);//adc数据处理任务优先级1,HandleADCDataProcessing为传出参数	理解
    xTaskCreate( vGarbage_box_check_task, "vGarbage_box_check_task", 310, 0, 1,0);//垃圾盒检测任务 优先级1	理解
    xTaskCreate( vGyroscopse_task,        "vGyroscopse_task",        310, 0, 2,0);//陀螺仪任务     优先级2	理解
    ...
    xTaskCreate( vPowerChipTask,          "vPowerChipTask",          120, 0, 1,0);//电池管理充电任务 优先级1	理解
